...
- **The road, pier, fence and wall layers are typed**: one byte per cell —
  ...
  road), `mappings.pierTypes` (1 pier — narrow, posted; 2 boardwalk — wide
  ...
  the WIDER family** (road or ruined road over dirt path): a path teeing into
  ...
  bridge — keep paths and ruined roads on land. Ruined-road potholes are
